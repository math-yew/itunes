...
var artistInfo = [];
    ...
    this.getSongData = function(artist) {
      ...
      $http({
        ...
        for(key in artistData){

          var info = {
            AlbumArt: artistData[key].artworkUrl30,
            Artist: artistData[key].trackName,
            Collection: artistData[key].collectionName,
            CollectionPrice: artistData[key].collectionPrice,
            Play: artistData[key].previewUrl,
            Type: artistData[key].kind
          }
